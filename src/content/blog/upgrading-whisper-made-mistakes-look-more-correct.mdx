...
<Figure
  ...
  caption="Three rates, four model sizes, identical audio and policy. Capture (blue) climbs cleanly. Aggregate wrong-commit rate (orange) barely moves — easy to mistake for noise. Severe-bucket wrong-commit rate (red) is the same story without the dilution: 0% at tiny.en, 64% at large-v3."
/>
